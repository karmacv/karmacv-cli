...
describe('Rendered HTML document', function () {
    var expressApp;
    beforeAll(function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var utilsService;
        return __generator(this, function (_a) {
            tsyringe_1.container.register('themePath', { useValue: appRoot + "/test/themes/kcv-theme-retro" });
            utilsService = tsyringe_1.container.resolve(utils_service_1.UtilsService);
            expressApp = new express_app_1.ExpressApp(5000, [tsyringe_1.container.resolve(compile_controller_1.CompileController)]);
            expressApp.listen();
            done();
            return [2 /*return*/];
        });
    ...
    it('should start server', function (done) {
        var jsonResume = require(appRoot + "/resume.json");
